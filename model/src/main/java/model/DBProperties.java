...
class DBProperties extends Properties {
	...
	/** The url. */
	private String							url										= "jdbc:mysql://localhost:3306/entrainement_projet?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
